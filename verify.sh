...
# addons/gmorn_beat へ submodule として入れるため、そこに project.godot が
...
sed -i '' 's|res://gmorn_|res://addons/gmorn_beat/gmorn_|g' "$work_dir/verify.gd" 2>/dev/null \
  || sed -i 's|res://gmorn_|res://addons/gmorn_beat/gmorn_|g' "$work_dir/verify.gd"
